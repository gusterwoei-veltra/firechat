...
export class AppToolbar {
    ...
    private changeUsername() {
        AppService.get().promptUsernameWhenNeeded(this.alertController, this.toastController, this.tempName, true)
    }
        ...
        return (
            <ion-header>
                <ion-toolbar color="primary">
                    ...
                    <ion-buttons class='profile' slot="end" onClick={() => this.changeUsername()}>
                        <ion-icon size='large' class='mr-1' name="contact"></ion-icon>
                        {/* <span class='mr-3 username'>{this.tempName}</span> */}
                    </ion-buttons>
                </ion-toolbar>
            </ion-header>
        );
